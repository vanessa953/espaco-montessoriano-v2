    ...
    <div style={pagina}>
      <div style={cabecalho}>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          <button onClick={() => irPara('/configuracoes')} style={botaoCinza}>
            Configurações
          </button>
      ...
      <div style={atalhos}>
        <button onClick={() => irPara('/pacientes')} style={botaoAtalho}>
          Novo paciente
        </button>

        <button onClick={() => irPara('/agenda')} style={botaoAtalho}>
          Novo atendimento
        </button>

        <button onClick={() => irPara('/prontuario')} style={botaoAtalho}>
          Novo prontuário
        </button>

        <button onClick={() => irPara('/financeiro')} style={botaoAtalho}>
          Financeiro
        </button>

        <button onClick={() => irPara('/profissionais')} style={botaoAtalho}>
          Profissionais
        </button>
      </div>
      ...
      <div style={box}>
        ...
        <textarea value={relatorioIA} readOnly style={textarea} />
